...
describe('truesight_protocol', () => {
  ...
  const TSDMintAccount          = new anchor.web3.PublicKey("AimRqLwN5vQSx8QFF6gvYa9CNqX4Zj4f6Agv58fgpEpJ");  
  const TokenProgramAccountID   = "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA";

  // Account used for testing
  const TestAccount             = new anchor.web3.PublicKey("6fW8HGLCrqcRGU6Gr95Z6iqmYR1ce1evmEGE7DGaHjZW");  
  const TestAccountTokenWallet  = new anchor.web3.PublicKey("B1oAr9oaZCtAWgGVJCAjaJTMAqoopj9et8km9WduEQy1");  
  ...
  describe('CreatePrediction', () => {
    ...
    it('creates prediction', async () => {
      ...
      console.log("PR p-key", predictionRecord.publicKey.toString())
      let holdoutPeriodSec = 604800;

      // Smallest unit is 0.0000000001
      let bidAmount = 10; // 7TSD   
      let direction = "UP";
